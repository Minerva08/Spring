 ...
 * Generated at: 2022-05-29 14:44:33 UTC
...
public final class buyList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			<div class=\"buyList_r_div1\"><h2>구매내역</h2></div>\r\n");
      out.write("			\r\n");
      out.write("			<div class=\"buyList_r_div2\">\r\n");
      out.write("				<ul class=\"jcsa aice\">\r\n");
      out.write("					<li class=\"event_li\" data-n=\"0\">\r\n");
      out.write("						<span id=\"buy_cnt1\" data-n=\"0\">0</span>\r\n");
      out.write("						<span data-n=\"0\">구매확정</span>\r\n");
      out.write("					</li>\r\n");
      out.write("					<li class=\"event_li\" data-n=\"1\">\r\n");
      out.write("						<span id=\"buy_cnt2\" data-n=\"1\">0</span>\r\n");
      out.write("						<span data-n=\"1\">결제내역</span>\r\n");
      out.write("					</li>\r\n");
      out.write("					<li class=\"event_li\" data-n=\"2\">\r\n");
      out.write("						<span id=\"buy_cnt3\" data-n=\"2\">0</span>\r\n");
      out.write("						<span data-n=\"2\">구매내역</span>\r\n");
      out.write("					</li>\r\n");
      out.write("				</ul>\r\n");
      out.write("				\r\n");
      ...
      out.write("						<div class=\"aice\">\r\n");
      out.write("							<input type=\"text\" placeholder=\"주문번호 검색\" id=\"input_search\" onkeyup=\"buysearch_number()\">\r\n");
      ...
      out.write("					\r\n");
      out.write("						<ul class=\"buylist_box_ul\">\r\n");
      out.write("\r\n");
      out.write("						</ul>\r\n");
      ...
      out.write("	// 선택자\r\n");
      out.write("	const randertarget = document.querySelector('.buylist_box_ul') // 랜더 타겟\r\n");
      out.write("	const more_view = document.querySelector('input[name=\"more_view\"]') // 더보기\r\n");
      out.write("	const sort_span_img = document.getElementById('sort_span_img') // 정렬 이미지1\r\n");
      out.write("	const sort_price_img = document.getElementById('sort_price_img') // 정렬 이미지2\r\n");
      out.write("	const border_bottom = document.querySelectorAll('.event_li') // 이벤트 li\r\n");
      out.write("	const sale_sortTrade_span = document.getElementById('sale_sort_span') // 정렬 버튼1\r\n");
      out.write("	const sale_sort_price = document.getElementById('sale_sort_price') // 정렬 가격\r\n");
      out.write("	const input_date1 = document.querySelector('input[name=\"input_date1\"]') // 날짜1\r\n");
      out.write("	const input_date2 = document.querySelector('input[name=\"input_date2\"]') // 날짜2\r\n");
      out.write("	const date_span = document.getElementById('date_span') // 날짜 조회\r\n");
      out.write("	const input_search = document.getElementById('input_search') // 검색 인풋\r\n");
      out.write("	const reset_search = document.getElementById('reset_search')\r\n");
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	// 변수\r\n");
      out.write("	const orlist = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${orjson}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("	console.log(orlist)\r\n");
      out.write("	const relist = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${rejson}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("	console.log(relist)\r\n");
      out.write("	const orarr = getArrjson(orlist)\r\n");
      out.write("	const rearr = getArrjson(relist)\r\n");
      out.write("	const nowurl = window.location.pathname\r\n");
      out.write("	\r\n");
      out.write("	let updown = 'up'\r\n");
      out.write("	let updownprice = 'up'	\r\n");
      out.write("	let orfilter = []\r\n");
      out.write("	let refilter = []\r\n");
      out.write("	let salepage = 0\r\n");
      out.write("	let data_ch = 0\r\n");
      out.write("	\r\n");
      out.write("	// 이벤트 주기	\r\n");
      out.write("	border_bottom.forEach(e => { // 클릭 이벤트\r\n");
      out.write("			e.addEventListener('click', clickHandler)\r\n");
      out.write("			if (e.dataset.n == 0) e.addEventListener('click', buyCheck)\r\n");
      out.write("			if (e.dataset.n == 1) e.addEventListener('click', buyReceipt)\r\n");
      out.write("			if (e.dataset.n == 2) e.addEventListener('click', buyAll)\r\n");
      out.write("		})\r\n");
      out.write("	more_view.addEventListener('click', getfetchbuy) // 더보기 이벤트\r\n");
      out.write("	sale_sortTrade_span.onclick = buysort // 정렬1\r\n");
      out.write("	sale_sort_price.onclick = buysortPrice // 정렬2\r\n");
      out.write("	date_span.onclick = buydateSort // 조회 이벤트\r\n");
      out.write("	reset_search.addEventListener('click', resetsearch) // 초기화\r\n");
      out.write("		\r\n");
      out.write("	// 페이지 요청시 발동\r\n");
      out.write("	nowpage(nowurl)\r\n");
      out.write("	border_bottom[0].click()\r\n");
      out.write("	document.getElementById('buy_cnt1').innerText = orarr.filter(v => v.order_check == 'N').length\r\n");
      out.write("	document.getElementById('buy_cnt2').innerText = rearr.length\r\n");
      out.write("	document.getElementById('buy_cnt3').innerText = orarr.length\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
